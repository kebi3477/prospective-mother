...
if($search == "제목"){
    $sql = "SELECT * FROM free_share WHERE title like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
if($search == "내용"){
    $sql = "SELECT * FROM free_share WHERE content like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
if($search == "작성자"){
    $sql = "SELECT * FROM free_share WHERE name like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
...
if($search == "제목"){
$sql = "select * from free_share where title like '%$search_text%' order by num desc limit $start, $view_article";
$result = $mysqli->query($sql);
}
if($search == "내용"){
    $sql = "select * from free_share where content like '%$search_text%' order by num desc limit $start, $view_article";
    $result = $mysqli->query($sql);
}
if($search == "작성자"){
    $sql = "select * from free_share where name like '%$search_text%' order by num desc limit $start, $view_article";
    $result = $mysqli->query($sql);
}
...
<head>
    ...
    <link rel="stylesheet" href="../css/free_search.css">
        ...
        <div class="main">
            <div class="main_body">
                    ...
                    ?>
                        <td class="img_td">
                            <div class="img_board">
                                ...
                                <a href="free_share_content.php?num=<?=$num?>"><img src="upload_img/<?=$img_string[0]?>"></a>
                            </div>
                ...
                <div class="board_bottom">
                    <div class="left">
                        <a href="free_share.php"><button>처음으로</button></a>
                    </div>
