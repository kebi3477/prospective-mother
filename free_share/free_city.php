...
$sql = "SELECT * FROM free_share WHERE address like '%$city%'";
...
<head>
    ...
    <link rel="stylesheet" href="../css/free_city.css">
...
<body>
                ...
                <ul class="map_list">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                            $count = 1; 
                            $sql2 = "SELECT * FROM free_share WHERE address like '%$city%' order by num desc limit $start, $view_article";
    ...
    ?>
            <div class="page_btn_grop">
                ...
                <?php
        echo "<a href=$_SERVER[PHP_SELF]?page=1&city=$city><span class='page_btn_class2'><img src='../imgs/ee.png'></span></a>";
    if($page != 1){
        echo "<a href=$_SERVER[PHP_SELF]?page=$prev_page&city=$city>
    ...
    for($i=$block_start; $i<=$block_end; $i++){ 
        ...
        if($page == $i){ //만약 page가 $i와 같다면 
          ...
          echo "<a href='?page=$i&city=$city'><span class='page_btn_class'>$i</span></a>"; //아니라면 $i*/
        }
      }
    if($page != $total_page){
        echo "<a href=$_SERVER[PHP_SELF]?page=$next_page&city=$city><span class='page_btn_class'>다음</span></a>";    
    }
    else{
        echo "<span class='page_btn_class'>다음</span></a>";
    }
        echo "<a href=$_SERVER[PHP_SELF]?page=$total_page&city=$city><span class='page_btn_class2'>
        <img src='../imgs/rr.png'>
        </span></a>";
