...
/*      조회수 중복방지 쿠키       */
if(isset($num) && !isset($_COOKIE['free_cookie'.$num])){
    
    $hit_sql = "UPDATE free_share SET hit = hit + 1 WHERE num='$num'";
    $result = $mysqli->query($hit_sql);
    
    if(isset($result)){
        setcookie('free_cookie'.$num, time() + 3600, '/'); 
...
<head>
    ...
    <link rel="stylesheet" href="../css/free_share_content.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.14.0/css/all.css"
        integrity="sha384-HzLeBuhoNPvSl5KYnjx0BT+WB0QEEqLprO+NBkkk5gbc67FTaL7XIGa2w1L0Xbgc" crossorigin="anonymous">
    <script src="../js/jquery-1.12.3.js" type="text/javascript"></script>
    <script src="../js/script.js" type="text/javascript" defer></script>
    <script src="../js/free_share.js" type="text/javascript" defer></script>
    <title>무료나눔</title>
</head>
...
<body>
    ...
    <div class="report_pop">
        <div class="report_body">
            ...
            <h2>게시글을 신고하시겠습니까?</h2>
            <form method="post" action="../board/report.php">
...
사유에따라 처리시간이 다소 지연될 수 있습니다."></textarea>
                ...
                <p class="report_bottom">
                    ...
                    <input type="hidden" name="val" value="무료나눔">
                </p>
            </form>
        </div>
    </div>
    ...
    <div class="delete_pop">
       <div class="delete_body">
          ...
          <h2>게시글을 삭제하시겠습니까?</h2>
          <div class="de_bottom">
             <a href="free_delete.php?num=<?=$num?>"><button>삭제하기</button></a>
             <button>취소</button>
          </div>
       </div>
    </div>
...
<?php
    $sql = "SELECT * FROM free_share WHERE num='$num'";
...
?>
            ...
            <div class="name_block">
                ...
                <div class="good_img">
                    <form method="POST" action="good.php" id="good">
                        <button type="button"><img src="../imgs/good.png" alt="좋아요이미지"></button>
                        <input type="hidden" name="good" value="0" id="good_val">
                        <input type="hidden" name="num" value="<?=$num?>">
                    </form>
                </div>
            </div>
...
?>
        <div class="img_content">
            <div id="prev_btn1" class="prev_btn">
                <img src="../imgs/slidebutton1.png">
            </div>
            <div class="img_slide">
                <div class="imgs">
...
?>              </div>
            ...
            <div id="prev_btn2" class="prev_btn">
                <img src="../imgs/slidebutton2.png">
            </div>
        </div>
                <br>
                <div class="add">
                    <p class="address_td">거래지역</p>
                    <p class="product">거래물품</p>
                </div>
                <div class="pro">
            ...
            <div class="the_text">
                <a href="../board/board_detail.php?name=<?=$row['name']?>"><span><?=$row['name']?>님의 게시글 더보기<i class="fas fa-angle-right" id="arrow"></i></span></a>
                <?php
                if(isset($_SESSION['user_nickname'])){
                    if($row['name'] == $_SESSION['user_nickname']){
                ?>
                <div class="up_delete">
                    <a href="free_revise_board.php?num=<?=$num?>"><span id="revise_go">수정</span></a>
...
<?php
    ...
    $resql = "SELECT * FROM free_reply WHERE board_num='$num' order by id desc";
    ...
    $sql2 = "SELECT * FROM free_reply WHERE board_num='$num' limit $start,$view_article";
...
?>                  
            <div class="that_content">
                <div class="con_flex">
                    ...
                    ?>
                            <p class="re_span">
                                <a href="free_reply_revise.php?id=<?=$re_num?>&num=<?=$num?>"><span class="reply_revise_btn">수정</span></a>
                                <span>|</span>
                                <a href="free_reply_delete.php?id=<?=$re_num?>&num=<?=$num?>"><span class="reply_delete_btn">삭제</span></a>
                            </p>
                    <?php
                        }
                        else if($_SESSION['user_nickname'] == "관리자"){
                    ?>
                        <p class="re_span">
                            <a href="reply_delete.php?id=<?=$re_num?>&num=<?=$num?>&val=pregnant"><span class="reply_delete_btn">삭제</span></a>
                        </p>
                    <?php
                        }
                    }
...
?>
            ...
            <div class="board_bottom">
                ...
                <div class="right_btn">
                    <a href="free_share.php"><button class="list"><span>목록</span></button></a>
                    <a href="#">
