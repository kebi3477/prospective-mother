...
$sql = "UPDATE free_share SET title = '$title', name = '$nick_name', img_src = '$str', address = '$address',
product = '$product', content = '$content', warning = '$warning', date = '$date' where num = '$num'";
