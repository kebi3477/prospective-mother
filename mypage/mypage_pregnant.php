...
$sql = "SELECT * FROM pregnant_board where name ='$nickname' order by num desc";
...
$sql2 = "select * from pregnant_board where name='$nickname' order by num desc limit $start, $view_article";
    ...
    <div class="main">
        <div class="main_body">
            ...
            ?>        
                            <tr>
                                <td><?=$cnt?></td>
                                <td><a href="../board/pregnant_content.php?num=<?=$row['num']?>"><?=$row['title']?></a></td>
                                <td><?=$row['name']?></td>
                                <td><?=$row['date']?></td>
                                <td><?=$row['hit']?></td>
