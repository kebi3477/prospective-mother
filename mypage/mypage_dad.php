...
$sql = "SELECT * FROM dad_board where name ='$nickname' order by num desc";
...
$sql2 = "select * from dad_board where name='$nickname' order by num desc limit $start, $view_article";
...
<head>
    ...
    <link rel="stylesheet" href="../css/mypage_dad.css">
        ...
        <div class="main_body">
            <div class="body_top">
                ...
                <div class="member">
                    ...
                    <span class="member_text" id="si_delete_go">회원탈퇴</span></a>
                </div>
            </div>
            ...
            ?>        
                            <tr>
                                <td><?=$cnt?></td>
                                <td><a href="../board/dad_content.php?num=<?=$row['num']?>"><?=$row['title']?></a></td>
                                <td><?=$row['name']?></td>
                                <td><?=$row['date']?></td>
                                <td><?=$row['hit']?></td>
