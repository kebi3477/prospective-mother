...
$sql = "SELECT * FROM free_share where name ='$nickname' order by num desc";
...
$sql2 = "select * from free_share where name='$nickname' order by num desc limit $start, $view_article";
...
<head>
    ...
    <link rel="stylesheet" href="../css/mypage_free.css">
    ...
    <div class="main">
        <div class="main_body">
            <div class="body_top">
                ...
                <div class="member">
                    <a href="../signup/signup_revise.php"><span class="member_text">회원정보수정</span></a>
            ...
            <div class="tab">
                ...
                <div class="board">
                    <div class="board_body">
                        <table class="board_table img_table">
                        <tr>
                    <?php
                    $count = 1; 
                ...
                ?>
                    <td class="img_td">
                        <div class="img_board">
                            ...
                            <a href="../free_share/free_share_content.php?num=<?=$num?>"><img
                                    src="../free_share/upload_img/<?=$img_string[0]?>"></a>
                        </div>
                        <a href="../free_share/free_share_content.php?num=<?=$num?>">
                            <div class="img_text">
                                <p class="img_title"><?=$row['title']?></p>
