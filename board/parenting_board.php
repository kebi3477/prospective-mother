...
$sql = "SELECT * FROM parenting_board order by num desc";
...
$sql2 = "select * from parenting_board order by num desc limit $start, $view_article";
...
<body>
        ...
        <div class="head">
            ...
            <div class="rmenu">
                <ul class="menu">
                    ...
                    <li class="menu_text"><a href="#">함께소통해요</a></li>
    ...
    <div class="imgslide">
        <a href="#"><img src="../imgs/board_back.jpg"></a>
    </div>
        <div class="board_text">
            <div class="left_title">
                <h2 class="parenting">육아</h2>
                <a href="pregnant_board.php"><h2 class="reserve">임신</h2></a>
                <a href="dad.php"><h2 class="dad">예비아빠</h2></a>
            </div>
            <form method="GET" action="parenting_search.php" class="search_form">
