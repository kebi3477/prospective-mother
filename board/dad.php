...
$sql = "SELECT * FROM dad_board order by num desc";
...
$sql2 = "select * from dad_board order by num desc limit $start, $view_article";
...
<head>
    ...
    <link rel="stylesheet" href="../css/dad_board.css">
...
<body>
    ...
    <div class="imgslide">
        <a href="#"><img src="../imgs/board_back3.jpg"></a>
    </div>
        <div class="board_text">
            <div class="left_title">
                <a href="parenting_board.php"><h2 class="parenting">육아</h2></a>
                <a href="pregnant_board.php"><h2 class="reserve">임신</h2></a>
                <h2 class="dad">예비아빠</h2>
            </div>
            <form method="GET" action="dad_search.php" class="search_form">
