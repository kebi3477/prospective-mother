...
$sql = "SELECT * FROM dad_board where name ='$board_name' order by num desc";
...
$sql2 = "select * from dad_board where name='$board_name' order by num desc limit $start, $view_article";
