...
$sql = "SELECT * FROM parenting_board where name ='$board_name' order by num desc";
...
$sql2 = "select * from parenting_board where name='$board_name' order by num desc limit $start, $view_article";
