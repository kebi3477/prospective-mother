...
if($search == "제목"){
    $sql = "SELECT * FROM pregnant_board WHERE title like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
if($search == "내용"){
    $sql = "SELECT * FROM pregnant_board WHERE content like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
if($search == "작성자"){
    $sql = "SELECT * FROM pregnant_board WHERE name like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
...
if($search == "제목"){
$sql = "select * from pregnant_board where title like '%$search_text%' order by num desc limit $start, $view_article";
$result = $mysqli->query($sql);
}
if($search == "내용"){
    $sql = "select * from pregnant_board where content like '%$search_text%' order by num desc limit $start, $view_article";
    $result = $mysqli->query($sql);
}
if($search == "작성자"){
    $sql = "select * from pregnant_board where name like '%$search_text%' order by num desc limit $start, $view_article";
    $result = $mysqli->query($sql);
}
...
<head>
    ...
    <link rel="stylesheet" href="../css/pregnant_search.css">
...
?>
            ...
            <div class="board_bottom">
                <div class="left">
                    <a href="pregnant_board.php"><button>처음으로</button></a>
                </div>
