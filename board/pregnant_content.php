...
if(isset($num) && !isset($_COOKIE['hit_cookie2'.$num])){
    ...
    $hit_sql = "UPDATE pregnant_board SET hit = hit + 1 WHERE num='$num'";
...
<head>
    ...
    <link rel="stylesheet" href="../css/pregnant_content.css">
...
사유에따라 처리시간이 다소 지연될 수 있습니다."></textarea>
                ...
                <p class="report_bottom">
                    ...
                    <input type="hidden" name="val" value="임신">
                </p>
            </form>
        </div>
    </div>
    ...
    <div class="delete_pop">
       <div class="delete_body">
          ...
          <h2>게시글을 삭제하시겠습니까?</h2>
          <div class="de_bottom">
             <a href="delete.php?num=<?=$num?>&val=pregnant"><button>삭제하기</button></a>
             <button>취소</button>
          </div>
       </div>
    </div>
...
?>
            ...
            <div class="name_block">
                ...
                <div class="good_img">
                    <form method="POST" action="good.php" id="good2">

                        <button type="button"><img src="../imgs/good.png" alt="좋아요이미지"></button>

                        <input type="hidden" name="good" value="2" id="good_val">
                        <input type="hidden" name="num" value="<?=$num?>">
                    </form>
                </div>
            </div>
...
?>
            ...
            if(isset($_SESSION['user_nickname'])){
                ...
                ?>
                <div class="up_delete">
                    <a href="revise_board.php?num=<?=$num?>&val=pregnant"><span id="revise_go">수정</span></a>
...
<?php
    ...
    $resql = "SELECT * FROM preg_reply WHERE board_num='$num'";
    ...
    $sql2 = "SELECT * FROM preg_reply WHERE board_num='$num' limit $start,$view_article";
...
?>                  
            <div class="that_content">
                <div class="con_flex">
                    ...
                    ?>
                    <p class="re_span">
                    <a href="reply_revise.php?id=<?=$re_num?>&num=<?=$num?>&val=pregnant"><span class="reply_revise_btn">수정</span></a>
                        <span>|</span>
...
?>
                ...
                <div class="that_writing">
                    ...
                    <form method="POST" action="reply.php" id="reply">
                        ...
                        <p>
                            ...
                            <input type="hidden" name="num" value="<?=$num?>">
                            <input type="hidden" name="re_num" value="임신">
                        </p>
                    </form>
                </div>
            </div>
            ...
            <div class="board_bottom">
                ...
                <div class="right_btn">
                    <a href="pregnant_board.php"><button class="list"><span>목록</span></button></a>
                    <a href="#">
