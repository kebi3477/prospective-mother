...
$sql = "SELECT * FROM free_share where name ='$board_name' order by num desc";
...
$sql2 = "select * from free_share where name='$board_name' order by num desc limit $start, $view_article";
    ...
    <div class="main">
        <div class="main_body">
            ...
            <div class="tab">
                ...
                <a href="pre_board_detail.php?name=<?=$board_name?>">
                    <div class="box box3">
                        <span>임신</span>
                    </div>
                </a>
