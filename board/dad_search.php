...
if($search == "제목"){
    $sql = "SELECT * FROM dad_board WHERE title like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
if($search == "내용"){
    $sql = "SELECT * FROM dad_board WHERE content like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
if($search == "작성자"){
    $sql = "SELECT * FROM dad_board WHERE name like '%$search_text%' order by num desc";
    $result = $mysqli->query($sql);
}
...
if($search == "제목"){
$sql = "select * from dad_board where title like '%$search_text%' order by num desc limit $start, $view_article";
$result = $mysqli->query($sql);
}
if($search == "내용"){
    $sql = "select * from dad_board where content like '%$search_text%' order by num desc limit $start, $view_article";
    $result = $mysqli->query($sql);
}
if($search == "작성자"){
    $sql = "select * from dad_board where name like '%$search_text%' order by num desc limit $start, $view_article";
    $result = $mysqli->query($sql);
}
...
<head>
    ...
    <link rel="stylesheet" href="../css/dad_search.css">
...
?>
                    <tr>
                        <td><?=$cnt?></td>
                        <td><a href="dad_content.php?num=<?=$row['num']?>"><?=$row['title']?></a></td>
                        <td><?=$row['name']?></td>
                        <td><?=$row['date']?></td>
                        <td><?=$row['hit']?></td>
...
?>
            ...
            <div class="board_bottom">
                <div class="left">
                    <a href="dad.php"><button>처음으로</button></a>
                </div>
